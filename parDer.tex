...
The following corollary can be directly derived from \cref{theo:inc-bound} and \cref{bounds}.
\begin{corollary}
...
$\theight{\re}$.
\begin{theorem}\label[theorem]{theo:zero-inc}
...
\begin{theorem}\label[theorem]{theo:gen-theo:inc-bound}
